...
class Categories_model extends Main_model
{
    ...
    public function get_all(){
        ...
        // return $data;
        $this->db->select('cates.name as name,cates.id as cid,usr.name as rest_name,cates.status as status,cates.restId as restId');
        $this->db->from("categories as cates");
        $this->db->join('store as usr','cates.restId = usr.uid');
