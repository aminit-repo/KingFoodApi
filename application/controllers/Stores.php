...
class Stores extends CI_Controller{
    ...
    public $_table_column_array = ['uid','name','mobile','lat','lng','verified','address','descriptions','images','cover','status','open_time','close_time','isClosed','certificate_url','certificate_type','rating','total_rating','cid','commission','cusine','dish','time'];
    public $_table_column_edit = ['id','uid','name','mobile','lat','lng','verified','address','descriptions','images','cover','status','open_time','close_time','isClosed','certificate_url','certificate_type','rating','total_rating','cid','commission','cusine','dish','time'];
    public $required = ['id'];
