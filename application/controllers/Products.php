...
class Products extends CI_Controller{
    ...
    public $_table_column_array = ['restId','cid','cover','details','price','rating','veg','name','variations','status','size'];
    public $_table_column_edit = ['id','restId','cid','cover','details','price','rating','veg','name','variations','status','size'];
    public $required = ['id'];
    ...
    public function getFoodByCid(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Product_model->getFoodByCid($_POST['id'],$_POST['cid']);
                if($result != null){
                    echo $this->json->response($result,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response($this->db->error(),$this->_Errmessage,$this->_statusErr);
    ...
    public function getSearchItems(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Product_model->getSearchItems($_POST['search'],$_POST['id']);
                if($result != null){
                    echo $this->json->response($result,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response($this->db->error(),$this->_Errmessage,$this->_statusErr);
