...
class Categories extends CI_Controller{
    ...
    public $_table_column_array = ['name','restId','status'];
    public $_table_column_edit = ['id','name','restId','status'];
    public $required = ['id'];
    ...
    public function getByRestId(){
        ...
        if($auth && $auth == $this->config->item('encryption_key')){
            ...
            if(isset($data) && !empty($data)){
                ...
                $result = $this->Categories_model->getByRestId($_POST['id']);
                if($result != null){
                    echo $this->json->response($result,$this->_OKmessage,$this->_statusOK);
                }else{
                    echo $this->json->response($this->db->error(),$this->_Errmessage,$this->_statusErr);
