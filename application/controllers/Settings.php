...
class Settings extends CI_Controller{
    ...
    public $_table_column_array = ['currencySymbol','currencySide','appDirection','logo','twillo','creds','delivery','home_ui','driver_login','store_login','user_login','web_login','reset_pwd','driver_assignments'];
    public $_table_column_edit = ['id','currencySymbol','currencySide','appDirection','logo','twillo','creds','delivery','home_ui','driver_login','store_login','user_login','web_login','reset_pwd','driver_assignments'];
    public $required = ['id'];
