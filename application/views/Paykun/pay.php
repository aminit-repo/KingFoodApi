...
<head>
    ...
    <script type="text/javascript">
        ...
        //     const pk = new PayKun({ merchantId : '902557083690162', accessToken: '93C3A71E592F1AF0FBC298176B2BA6E6', isLive: true});
        //     function initPayment() {
        //         let order = {
        //             amount: "10", // Amount to collect
        //             orderId: "Foodies" + (new Date).getTime(), // Unique order id, You can use your custom login here, but make sure it generates unique ID everytime
        ...
        //                     window.location.href = '<?php echo $callback; ?>'+transaction.transaction.payment_id;
        ...
        //                 var transaction = pk.getTransactionDetail(transactionId, function(transaction) {
        //                     console.log(transaction);
        //                     window.location.href = '<?php echo $onClose; ?>'+transaction.transaction.payment_id;
